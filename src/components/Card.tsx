...
const Card: React.FC<CardProps> = ({ title, subtitle, children, className = '', style, headerAction, onClick }) => {
    return (
        <div
            onClick={onClick}
            style={style}
            ...
            {(title || headerAction) && (
                <div className="flex justify-between items-center mb-6 last:mb-0">
                    <div className="flex flex-col">
                        {title && <h3 className="font-bold text-base text-foreground leading-tight">{title}</h3>}
